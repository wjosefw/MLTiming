...
nbins = 131                                # Num bins for all histograms
...
train_array, train_time_array, a, b = extract_signal_along_time(train_data, fraction = fraction, window_low = window_low, window_high = window_high)
val_array, val_time_array, _ , _ = extract_signal_along_time(validation_data, fraction = fraction, window_low = window_low, window_high = window_high)
test_array, test_time_array, _ , _ = extract_signal_along_time(test_data, fraction = fraction, window_low = window_low, window_high = window_high)
...
#
#MOMENTS_TEST_02_0 = momentos(np.expand_dims(TEST_02[:,:,0], axis = -1), np.expand_dims(test_time_array[:,:,0], axis = -1), order = moments_order)
#MOMENTS_TEST_02_1 = momentos(np.expand_dims(TEST_02[:,:,1], axis = -1), np.expand_dims(test_time_array[:,:,1] + t_shift*time_step/120, axis=-1), order = moments_order)
#MOMENTS_TEST_02 = np.stack((np.squeeze(MOMENTS_TEST_02_0, axis=-1), np.squeeze(MOMENTS_TEST_02_1, axis=-1)), axis = -1)
#
#MOMENTS_TEST_04_0 = momentos(np.expand_dims(TEST_04[:,:,0], axis = -1), np.expand_dims(test_time_array[:,:,0], axis = -1), order = moments_order)
#MOMENTS_TEST_04_1 = momentos(np.expand_dims(TEST_04[:,:,1], axis = -1), np.expand_dims(test_time_array[:,:,1] + 2*t_shift*time_step/120, axis=-1), order = moments_order)
#MOMENTS_TEST_04 = np.stack((np.squeeze(MOMENTS_TEST_04_0, axis=-1), np.squeeze(MOMENTS_TEST_04_1, axis=-1)), axis = -1)
#                           
#MOMENTS_TEST_20_1 = momentos(np.expand_dims(TEST_20[:,:,1], axis = -1), np.expand_dims(test_time_array[:,:,1], axis = -1), order = moments_order)
#MOMENTS_TEST_20_0 = momentos(np.expand_dims(TEST_20[:,:,0], axis = -1), np.expand_dims(test_time_array[:,:,0] + t_shift*time_step/120, axis=-1), order = moments_order)
#MOMENTS_TEST_20 = np.stack((np.squeeze(MOMENTS_TEST_20_0, axis=-1), np.squeeze(MOMENTS_TEST_20_1, axis=-1)), axis = -1)
#
#MOMENTS_TEST_40_1 = momentos(np.expand_dims(TEST_40[:,:,1], axis = -1), np.expand_dims(test_time_array[:,:,1], axis = -1), order = moments_order)
#MOMENTS_TEST_40_0 = momentos(np.expand_dims(TEST_40[:,:,0], axis = -1), np.expand_dims(test_time_array[:,:,0] + 2*t_shift*time_step/120, axis=-1), order = moments_order)
#MOMENTS_TEST_40 = np.stack((np.squeeze(MOMENTS_TEST_40_0, axis=-1), np.squeeze(MOMENTS_TEST_40_1, axis=-1)), axis = -1)
#
