...
from functions import (momentos_threshold, create_position, set_seed, calculate_gaussian_center, 
                       ...
                       continuous_delay, extract_signal_along_time_singles, create_and_delay_pulse_pair_along_time)
...
total_time = time_step*data_55.shape[1] - time_step  # time_step*data_55.shape[1] - time_step
...
# Extract pulses
train_array_dec0, train_time_array_dec0 = extract_signal_along_time_singles(new_train[:,:100,0], time_step, total_time, fraction = fraction, window_low = window_low, window_high = window_high)
train_array_dec1, train_time_array_dec1 = extract_signal_along_time_singles(new_train[:,:100,1], time_step, total_time, fraction = fraction, window_low = window_low, window_high = window_high)

val_array_dec0, val_time_array_dec0 = extract_signal_along_time_singles(new_val[:,:100,0], time_step, total_time, fraction = fraction, window_low = window_low, window_high = window_high)
val_array_dec1, val_time_array_dec1 = extract_signal_along_time_singles(new_val[:,:100,1], time_step, total_time, fraction = fraction, window_low = window_low, window_high = window_high)

test_array_dec0, test_time_array_dec0  = extract_signal_along_time_singles(new_test[:,:100,0], time_step, total_time, fraction = fraction, window_low = window_low, window_high = window_high)
test_array_dec1, test_time_array_dec1  = extract_signal_along_time_singles(new_test[:,:100,1], time_step, total_time, fraction = fraction, window_low = window_low, window_high = window_high)
...
plt.hist(test_dec0[-1,:data_55[6000:,:,:].shape[0]], bins = nbins, alpha = 0.5, range = [0.5,3], label = '55')
plt.hist(test_dec0[-1, data_55[6000:,:,:].shape[0]: data_55[6000:,:,:].shape[0]+ data_28[6000:,:,:].shape[0]], bins = nbins, alpha = 0.5, label = '28')
plt.hist(test_dec0[-1, data_55[6000:,:,:].shape[0]+ data_28[6000:,:,:].shape[0]:], bins = nbins, alpha = 0.5, label = '82')
plt.title('Prediction times histograms dec0')
plt.legend()
plt.show()

# Plot histograms of predictions for the different positions
plt.hist(test_dec1[-1,:data_55[6000:,:,:].shape[0]], bins = nbins, alpha = 0.5, label = '55')
plt.hist(test_dec1[-1, data_55[6000:,:,:].shape[0]: data_55[6000:,:,:].shape[0]+ data_28[6000:,:,:].shape[0]], bins = nbins, alpha = 0.5, label = '28')
plt.hist(test_dec1[-1, data_55[6000:,:,:].shape[0]+ data_28[6000:,:,:].shape[0]:], bins = nbins, alpha = 0.5, label = '82')
plt.title('Prediction times histograms dec1')
plt.legend()
plt.show()
