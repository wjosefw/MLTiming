...
from functions import (extract_signal_along_time_singles, momentos_threshold, set_seed, 
                       normalize, normalize_given_params, create_and_delay_pulse_pair_along_time, 
                       create_dataloaders, Calculate_CFD)
...
# Extract pulses
train_array, train_time_array = extract_signal_along_time_singles(train_data[:, :, channel], time_step, fraction = fraction_pc, window_low = window_low, window_high = window_high)
val_array, val_time_array = extract_signal_along_time_singles(validation_data[:,:, channel], time_step, fraction = fraction_pc, window_low = window_low, window_high = window_high)
test_array, test_time_array = extract_signal_along_time_singles(test_data[:,:, channel], time_step, fraction = fraction_pc, window_low = window_low, window_high = window_high)
