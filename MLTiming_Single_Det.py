...
total_time = time_step*train_data_55.shape[1] - time_step  
...
# Extract pulses
train_array, train_time_array = extract_signal_along_time_singles(train_data[:, :100, channel], time_step, total_time, fraction = fraction, window_low = window_low, window_high = window_high)
val_array, val_time_array = extract_signal_along_time_singles(validation_data[:,:100,channel], time_step, total_time, fraction = fraction, window_low = window_low, window_high = window_high)
test_array, test_time_array = extract_signal_along_time_singles(test_data[:,:100,channel], time_step, total_time, fraction = fraction, window_low = window_low, window_high = window_high)
